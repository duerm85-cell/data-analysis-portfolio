...
# 配置参数
# 使用最新日期范围（从2020年到当前日期，确保有足够的数据量）
start_date = '20200101'
end_date = '20260428'  # 当前日期
raw_path = './data/raw/'
...
def get_stock_list():
    ...
    # 获取沪深300成分股
    try:
        hs300 = pro.index_weight(index_code='000300.SH', start_date='20251201', end_date='20260428')
    ...
    # 获取创业板指成分股
    try:
        cyb = pro.index_weight(index_code='399006.SZ', start_date='20251201', end_date='20260428')
    ...
    # 获取上证50成分股
    try:
        sz50 = pro.index_weight(index_code='000016.SH', start_date='20251201', end_date='20260428')
    ...
    for i, code in enumerate(stock_list, 1):
        try:
            ...
            if not df.empty:
                ...
                # 保存为CSV文件
                df.to_csv(f"{raw_path}{simple_code}_daily.csv", index=False)
