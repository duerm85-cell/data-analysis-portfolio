...
在本科阶段系统学习了 Python 数据分析、MySQL、统计学、机器学习、Hadoop/Spark、数据可视化等相关课程，并完成了基于多因子与市场情绪融合的 A 股量化分析系统毕业设计。
...
围绕 A 股市场构建多因子量化分析框架，并结合市场情绪相关指标进行综合分析，完成数据处理、因子构建、因子分析、策略研究及结果可视化等工作。
...
（后续补充：整理本科阶段的数据分析、数据清洗和可视化练习项目）

---

### 03 · SQL 数据分析实践

（后续补充：通过实际业务数据练习 MySQL 数据查询与分析，包括多表关联 / 聚合 / 子查询 / 窗口函数 / 用户行为 / 指标统计）
